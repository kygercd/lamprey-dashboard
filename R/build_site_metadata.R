...
# weekly refresh costs nothing and means new arrays / release
...
# even if a particular API call fails (and it covers a couple of
# MRR trap sites, like METTRP/TWITRP, that PTAGIS's sites API
# doesn't list at all).
# -------------------------------------------------------------
