# fetch_ptagis.R
# -------------------------------------------------------------
# Weekly pull of translocated / juvenile Pacific Lamprey data
# from PTAGIS scheduled exports.
#
# PTAGIS-side setup (one-time, per query):
#   1. Build the saved query in Advanced Reporting.
#   2. Subscribe To -> File (CSV, weekly). PTAGIS will write
...
# (the SAP BusinessObjects default) for some queries. We detect
# the BOM and re-encode to UTF-8 before writing.
#
